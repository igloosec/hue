...
setup(
  ...
  entry_points = { 'desktop.sdk.application': 'single_analysis=single_analysis' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'single_analysis': expand_package_data(
      ["src/single_analysis/templates", "src/single_analysis/static"],
      "src/single_analysis/")
  }
)
